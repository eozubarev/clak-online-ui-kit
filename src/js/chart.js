        ...
        !(function (t, e) {
            ...
            function Ut(t, e, i, n) {
                ...
                for (l = 0; l < r; l++)
                    ...
                    else if (Y(d)) for (c = 0, h = d.length; c < h; c++) (u = d[c]), null == u || Y(u) || (a = Yt(t, o, s, a, u));
                t.restore();
                const f = s.length / 2;
                if (f > i.length) {
            ...
            function ee(t, e, i, n, o, s = {}) {
                ...
                for (
                    ...
                    (c = a[l]),
                        r && (s.strokeColor && (t.strokeStyle = s.strokeColor), $(s.strokeWidth) || (t.lineWidth = s.strokeWidth), t.strokeText(c, i, n, s.maxWidth)),
            ...
            function ye(t, e, i, n) {
                ...
                return (
                    (c = Math.max(0, c - s.width)), (h = Math.max(0, n ? Math.floor(c / n) : h - s.height)), (c = _e(Math.min(c, a, l.maxWidth))), (h = _e(Math.min(h, r, l.maxHeight))), c && !h && (h = _e(c / 2)), { width: c, height: h }
                );
            }
            function ve(t, e, i) {
                const n = e || 1,
                ...
                return (
                    ...
                    (t.currentDevicePixelRatio !== n || a.height !== o || a.width !== s) && ((t.currentDevicePixelRatio = n), (a.height = o), (a.width = s), t.ctx.setTransform(n, 0, 0, n, 0, 0), !0)
                );
            }
            const we = (function () {
                let t = !1;
                ...
                for (o = 0, s = t.length; o < s; ++o)
                    (a = t[o]),
                        ...
                        a.horizontal
                            ...
                            : ((r.left = l), (r.right = l + r.width), (r.top = r.fullSize ? n.top : e.top), (r.bottom = r.fullSize ? i.outerHeight - n.bottom : e.top + e.h), (r.height = r.bottom - r.top), (l = r.right));
                (e.x = l), (e.y = c);
            }
                ...
                acquireContext(t, e) {
                    ...
                    return i && i.canvas === t
                        ? ((function (t, e) {
                              ...
                              if (
                                  ((t.$chartjs = { initial: { height: n, width: o, style: { display: i.display, height: i.height, width: i.width } } }), (i.display = i.display || "block"), (i.boxSizing = i.boxSizing || "border-box"), ei(o))
                              ) {
                                  const e = Me(t, "width");
                                  void 0 !== e && (t.width = e);
                              }
            ...
            xt.describe("animation", { _fallback: !1, _indexable: !1, _scriptable: (t) => "onProgress" !== t && "onComplete" !== t && "fn" !== t }),
                xt.set("animations", { colors: { type: "color", properties: ["color", "borderColor", "backgroundColor"] }, numbers: { type: "number", properties: ["x", "y", "borderWidth", "radius", "tension"] } }),
            ...
            class Ei {
                ...
                _update(t) {
                    ...
                    e.configure(),
                        ...
                        (i._clip = (function (t) {
                            let e, i, n, o;
                            return U(t) ? ((e = t.top), (i = t.right), (n = t.bottom), (o = t.left)) : (e = i = n = o = t), { top: e, right: i, bottom: n, left: o, disabled: !1 === t };
                        })(
                            K(
                                e.options.clip,
                                (function (t, e, i) {
            ...
            xt.set("scale", {
                ...
                xt.describe("scale", { _fallback: !1, _scriptable: (t) => !t.startsWith("before") && !t.startsWith("after") && "callback" !== t && "parser" !== t, _indexable: (t) => "borderDash" !== t && "tickBorderDash" !== t }),
            ...
            class qi extends zi {
                ...
                update(t, e, i) {
                    ...
                    n.beforeUpdate(),
                        ...
                        n._dataLimitsCached || (n.beforeDataLimits(), n.determineDataLimits(), n.afterDataLimits(), (n._range = We(n, n.options.grace)), (n._dataLimitsCached = !0)),
                        n.beforeBuildTicks(),
                    ...
                    n._convertTicksToLabels(a ? ji(n.ticks, s) : n.ticks),
                        ...
                        o.display && (o.autoSkip || "auto" === o.source) && ((n.ticks = Wi(n, n.ticks)), (n._labelSizes = null)),
                ...
                calculateLabelRotation() {
                    ...
                    (a = e.offset ? t.maxWidth / n : f / (n - 1)),
                        d + 6 > a &&
                            ...
                            (r = t.maxHeight - Yi(e.grid) - i.padding - Ui(e.title, t.chart.options.font)),
                            (l = Math.sqrt(d * d + u * u)),
                            (c = zt(Math.min(Math.asin(Math.min((h.highest.height + 6) / a, 1)), Math.asin(Math.min(r / l, 1)) - Math.asin(u / l)))),
                    ...
                    if (i.display)
                        for (s = 0, a = o.length; s < a; ++s) {
                            ...
                            i.drawOnChartArea && r({ x: t.x1, y: t.y1 }, { x: t.x2, y: t.y2 }, t),
                                i.drawTicks && r({ x: t.tx1, y: t.ty1 }, { x: t.tx2, y: t.ty2 }, { color: t.tickColor, width: t.tickWidth, borderDash: t.tickBorderDash, borderDashOffset: t.tickBorderDashOffset });
                        }
                }
                drawBorder() {
                    const t = this,
                    ...
                    const a = n.setContext(t.getContext(0)).lineWidth,
                        r = t._borderValue;
                    let l, c, h, d;
                    t.isHorizontal() ? ((l = Xt(e, t.left, s) - s / 2), (c = Xt(e, t.right, a) + a / 2), (h = d = r)) : ((h = Xt(e, t.top, s) - s / 2), (d = Xt(e, t.bottom, a) + a / 2), (l = c = r)),
                        i.save(),
                ...
                drawTitle() {
                    ...
                    const { titleX: c, titleY: h, maxWidth: d, rotation: u } = (function (t, e, i, n) {
                        ...
                        let c,
                            ...
                            d,
                            u = 0;
                        return t.isHorizontal() ? ((h = o(n, a, l)), (d = Hi(t, i, e)), (c = l - a)) : ((h = Hi(t, i, e)), (d = o(n, r, s)), (u = "left" === i ? -Mt : Mt)), { titleX: h, titleY: d, maxWidth: c, rotation: u };
                    })(this, l, e, r);
            ...
            function Ki(t, e = [""], i = t, n, o = () => t[0]) {
                ...
                const s = { [Symbol.toStringTag]: "Object", _cacheable: !0, _scopes: t, _rootScopes: i, _fallback: n, _getTarget: o, override: (o) => Ki([o, ...t], e, i, n) };
                return new Proxy(s, {
                    ...
                    for (let h = 0; h < n - 1; ++h)
                        (l = c),
                            ...
                            l &&
                                ...
                                (At(e[h], 0, cn)
                                    ? (i[h] = i[h + 1] = 0)
                                    : ((o = i[h] / e[h]), (s = i[h + 1] / e[h]), (r = Math.pow(o, 2) + Math.pow(s, 2)), r <= 9 || ((a = 3 / Math.sqrt(r)), (i[h] = o * a * e[h]), (i[h + 1] = s * a * e[h]))));
                })(t, o, s),
                    (function (t, e, i = "x") {
                        const n = dn(i),
                            o = t.length;
                    ...
                    (function (t, e) {
                        ...
                        for (i = 0, n = t.length; i < n; ++i)
                            (a = s),
                                (s = r),
                                (r = i < n - 1 && Gt(t[i + 1], e)),
                                s && ((o = t[i]), a && ((o.cp1x = gn(o.cp1x, e.left, e.right)), (o.cp1y = gn(o.cp1y, e.top, e.bottom))), r && ((o.cp2x = gn(o.cp2x, e.left, e.right)), (o.cp2y = gn(o.cp2y, e.top, e.bottom))));
                    })(t, i);
            }
            function mn(t, e, i, n) {
            ...
            function wn(t) {
                return "angle" === t ? { between: Nt, compare: Vt, normalize: Wt } : { between: (t, e, i) => t >= Math.min(e, i) && t <= Math.max(i, e), compare: (t, e) => t - e, normalize: (t) => t };
            }
            ...
            function kn(t, e, i) {
                ...
                for (let t = h, i = h; t <= d; ++t)
                    (m = e[t % a]),
                        m.skip ||
                            ((p = c(m[n])),
                            p !== x && ((b = l(p, o, s)), null === _ && y() && (_ = 0 === r(p, o) ? t : i), null !== _ && v() && (g.push(Mn({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)), (i = t), (x = p)));
            ...
            function Yn(t, e, i) {
                ...
                let s = n.get(o);
                if (!s) {
                    (s = { resolver: Ki(e, i), subPrefixes: i.filter((t) => !t.toLowerCase().includes("hover")) }), n.set(o, s);
                }
                return s;
            }
            ...
            class eo {
                constructor(t, e) {
                    ...
                    (this.id = j()),
                        ...
                        (Jn[n.id] = n),
                        l && c ? (a.listen(n, "complete", Kn), a.listen(n, "progress", Gn), n._initialize(), n.attached && n.update()) : console.error("Failed to create chart: can't acquire context from the given item");
                }
                get aspectRatio() {
                    const {
                    ...
                    i &&
                        ...
                        J(s, (i) => {
                            ...
                            if (a in n && n[a].type === l) c = n[a];
                                ...
                                (c = new (Ln.getScale(l))({ id: a, type: l, ctx: t.ctx, chart: t })), (n[c.id] = c);
                            }
                            c.init(s, e);
                        }),
                        J(o, (t, e) => {
                ...
                render() {
                    const t = this;
                    !1 !== t.notifyPlugins("beforeRender", { cancelable: !0 }) && (a.has(t) ? t.attached && !a.running(t) && a.start(t) : (t.draw(), Kn({ chart: t })));
                }
                draw() {
                    const t = this;
                    let e;
                ...
                _drawDataset(t) {
                    ...
                    !1 !== e.notifyPlugins("beforeDatasetDraw", a) &&
                        (o && Zt(i, { left: !1 === n.left ? 0 : s.left - n.left, right: !1 === n.right ? e.width : s.right + n.right, top: !1 === n.top ? 0 : s.top - n.top, bottom: !1 === n.bottom ? e.height : s.bottom + n.bottom }),
                        t.controller.draw(),
                        o && Qt(i),
                        (a.cancelable = !1),
                ...
                _handleEvent(t, e) {
                    ...
                    return (
                        ...
                        (i._lastEvent = null),
                        Gt(t, i.chartArea, i._minPadding) && (Q(o.onHover, [t, r, i], i), ("mouseup" !== t.type && "click" !== t.type && "contextmenu" !== t.type) || Q(o.onClick, [t, r, i], i)),
                        (l = !tt(r, n)),
            ...
            (uo.id = "bar"),
                (uo.defaults = { datasetElementType: !1, dataElementType: "bar", categoryPercentage: 0.8, barPercentage: 0.9, grouped: !0, animations: { numbers: { type: "number", properties: ["x", "y", "base", "width", "height"] } } }),
                (uo.overrides = { interaction: { mode: "index" }, scales: { _index_: { type: "category", offset: !0, grid: { offset: !0 } }, _value_: { type: "linear", beginAtZero: !0 } } });
            class fo extends Ei {
                initialize() {
            ...
            (fo.id = "bubble"),
                (fo.defaults = { datasetElementType: !1, dataElementType: "point", animations: { numbers: { type: "number", properties: ["x", "y", "borderWidth", "radius"] } } }),
                (fo.overrides = { scales: { x: { type: "linear" }, y: { type: "linear" } }, plugins: { tooltip: { callbacks: { title: () => "" } } } });
            class go extends Ei {
                constructor(t, e) {
            ...
            (go.id = "doughnut"),
                ...
                (go.descriptors = { _scriptable: (t) => "spacing" !== t, _indexable: (t) => "spacing" !== t }),
                (go.overrides = {
                    aspectRatio: 1,
                    plugins: {
                        legend: {
                                ...
                                generateLabels(t) {
                                    ...
                                    if (e.labels.length && e.datasets.length) {
                                        ...
                                        return e.labels.map((e, n) => {
                                            ...
                                            return { text: e, fillStyle: o.backgroundColor, strokeStyle: o.borderColor, lineWidth: o.borderWidth, pointStyle: i, hidden: !t.getDataVisibility(n), index: n };
                                        });
                                    }
                                    return [];
                                },
            ...
            (bo.id = "radar"),
                (bo.defaults = { datasetElementType: "line", dataElementType: "point", indexAxis: "r", showLine: !0, elements: { line: { fill: "start" } } }),
                (bo.overrides = { aspectRatio: 1, scales: { r: { type: "radialLinear" } } });
            class _o extends po {}
            (_o.id = "scatter"),
            ...
            function So(t, e, i, n, o) {
                ...
                s.borderWidth &&
                    (a ? ((t.lineWidth = 2 * s.borderWidth), (t.lineJoin = "round")) : ((t.lineWidth = s.borderWidth), (t.lineJoin = "bevel")),
                    e.fullCircles &&
                        (function (t, e, i) {
                ...
                Ro && 1 === e.segments.length
                    ...
                    : (function (t, e, i, n) {
                          const { segments: o, options: s } = e,
                              a = Lo(e);
                          for (const r of o) Do(t, s, r.style), t.beginPath(), a(t, e, r, { start: i, end: i + n - 1 }) && t.closePath(), t.stroke();
                      })(t, e, i, n);
            }
            class zo extends zi {
                constructor(t) {
            ...
            (zo.id = "line"),
                ...
                (zo.descriptors = { _scriptable: !0, _indexable: (t) => "borderDash" !== t && "fill" !== t });
            class Fo extends zi {
                constructor(t) {
            ...
            function Bo(t, e) {
                ...
                let r, l, c, h, d;
                return (
                    t.horizontal ? ((d = a / 2), (r = Math.min(i, o)), (l = Math.max(i, o)), (c = n - d), (h = n + d)) : ((d = s / 2), (r = i - d), (l = i + d), (c = Math.min(n, o)), (h = Math.max(n, o))),
            ...
            (Fo.id = "point"),
                (Fo.defaults = { borderWidth: 1, hitRadius: 1, hoverBorderWidth: 1, hoverRadius: 4, pointStyle: "circle", radius: 3, rotation: 0 }),
                    ...
                    t.data.datasets.forEach((e, o) => {
                        ...
                        let h,
                            { start: d, count: u } = (function (t, e) {
                                ...
                                return l && (o = Ht(se(e, s.axis, a).lo, 0, i - 1)), (n = c ? Ht(se(e, s.axis, r).hi + 1, o, i) - o : i - o), { start: o, count: n };
                            })(r, l);
                        if (u <= 4 * n) qo(e);
                        else {
                            switch (
                ...
                return (t.scale || {}).getPointPositionForValue
                    ? (function (t) {
                          ...
                          if (((h = "start" === i ? a : "end" === i ? r : U(i) ? i.value : e.getBaseValue()), n.grid.circular))
                              return (c = e.getPointPositionForValue(0, a)), new Qo({ x: c.x, y: c.y, radius: e.getDistanceFromCenterForValue(h) });
            ...
            function ss(t, e) {
                ...
                return (
                    ...
                    i.length ? new zo({ points: i, options: { tension: 0 }, _loop: n, _fullLoop: n }) : null
                );
            }
            function as(t, e, i) {
                let n = t[e].fill;
                        ...
                        for (const t of n) {
                            ...
                            for (const e of c) {
                                const n = ls(i, s[e.start], s[e.end], e.loop),
                                    r = kn(t, o, n);
                                for (const t of r) a.push({ source: t, target: e, start: { [i]: cs(l, n, "start", Math.max) }, end: { [i]: cs(l, n, "end", Math.min) } });
                            }
                        }
                        return a;
                    })(i, n, o);
            ...
            function fs(t, e, i) {
                ...
                n &&
                    ...
                    (function (t, e) {
                        ...
                        t.save(),
                            "x" === l && s !== o && (rs(t, n, a.top), us(t, { line: i, target: n, color: o, scale: r, property: l }), t.restore(), t.save(), rs(t, n, a.bottom)),
                ...
                afterDatasetsUpdate(t, e, i) {
                    ...
                    for (a = 0; a < n; ++a)
                        (s = t.getDatasetMeta(a)),
                            (r = s.dataset),
                            (l = null),
                            r && r.options && r instanceof zo && (l = { visible: t.isDatasetVisible(a), index: a, fill: Zo(r, a, n), chart: t, axis: s.controller.options.indexAxis, scale: s.vScale, line: r }),
                            (s.$filler = l),
                            o.push(l);
            ...
            class ms extends zi {
                ...
                _draw() {
                    ...
                    t.legendItems.forEach((M, k) => {
                        ...
                        h.setWidth(t.width),
                            y
                                ? k > 0 && C + D + f > t.right && ((O = m.y += w), m.line++, (C = m.x = o(r, t.left + f, t.right - n[m.line])))
                                : k > 0 && O + w > t.bottom && ((C = m.x = C + i[m.line].width + f), m.line++, (O = m.y = o(r, t.top + v + f, t.bottom - i[m.line].height)));
                        !(function (t, e, i) {
            ...
            class bs extends zi {
                ...
                _drawArgs(t) {
                    ...
                    let l,
                        ...
                        d = 0;
                    return (
                        this.isHorizontal() ? ((c = o(r, i, s)), (h = e + t), (l = s - i)) : ("left" === a.position ? ((c = i + t), (h = o(r, n, e)), (d = -0.5 * bt)) : ((c = s - t), (h = o(r, e, n)), (d = 0.5 * bt)), (l = n - e)),
            ...
            class Rs extends zi {
                ...
                drawTitle(t, e, i) {
                    ...
                    if (s) {
                        ...
                        for (t.x = Ts(n, i.titleAlign, i), e.textAlign = c.textAlign(i.titleAlign), e.textBaseline = "middle", a = Be(i.titleFont), r = i.titleSpacing, e.fillStyle = i.titleColor, e.font = a.string, l = 0; l < s; ++l)
                ...
                drawBody(t, e, i) {
                    ...
                    let m, x, b, _, y, v, w;
                    for (
                        e.textAlign = a, e.textBaseline = "middle", e.font = h.string, t.x = Ts(n, p, i), e.fillStyle = i.bodyColor, J(n.beforeBody, g), u = r && "right" !== p ? ("center" === a ? c / 2 + 1 : c + 2) : 0, _ = 0, v = o.length;
                        _ < v;
                        ++_
                    ) {
                ...
                drawFooter(t, e, i) {
                    ...
                    if (s) {
                        ...
                        for (
                            t.x = Ts(n, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = l.textAlign(i.footerAlign), e.textBaseline = "middle", a = Be(i.footerFont), e.fillStyle = i.footerColor, e.font = a.string, r = 0;
                            r < s;
                            ++r
                        )
                ...
                draw(t) {
                    ...
                    i.enabled &&
                        r &&
                        (t.save(), (t.globalAlpha = n), e.drawBackground(s, t, o, i), yn(t, i.textDirection), (s.y += a.top), e.drawTitle(s, t, i), e.drawBody(s, t, i), e.drawFooter(s, t, i), vn(t, i.textDirection), t.restore());
                }
                getActiveElements() {
                    return this._active || [];
                }
                ...
                buildTicks() {
                    ...
                    const o = (function (t, e) {
                        ...
                        (M = Math.ceil(p / k) - Math.floor(g / k)),
                            ...
                            "ticks" === n ? ((v = Math.floor(g / k) * k), (w = Math.ceil(p / k) * k)) : ((v = g), (w = p)),
                            m && x && o && Lt((a - s) / o, k / 1e3)
                                ? ((M = Math.round(Math.min((a - s) / k, c))), (k = (a - s) / M), (v = s), (w = a))
                                : b
                                ? ((v = m ? s : v), (w = x ? a : w), (M = l - 1), (k = (w - v) / M))
                                : ((M = (w - v) / k), (M = At(M, Math.round(M), k / 1e3) ? Math.round(M) : Math.ceil(M)));
                ...
                buildTicks() {
                    const t = this,
                        ...
                        i = (function (t, e) {
                            ...
                            do {
                                o.push({ value: s, major: Ns(s) }), ++r, 10 === r && ((r = 1), ++a, (l = a >= 0 ? 1 : l)), (s = Math.round(r * Math.pow(10, a) * l) / l);
                            } while (a < i || (a === i && r < n));
                            const c = q(t.max, s);
                                ...
                                if (0 !== i) {
                                    ...
                                    !(function (t, e, i, n) {
                                        ...
                                        (!s && !n) ||
                                            ...
                                            !r ||
                                            i < 0 ||
                                            (o.save(), (o.strokeStyle = a), (o.lineWidth = r), o.setLineDash(e.borderDash), (o.lineDashOffset = e.borderDashOffset), o.beginPath(), Ks(t, i, s, n), o.closePath(), o.stroke(), o.restore());
                                    })(t, n, r, s);
                                }
                            }),
                        n.display)
            ...
            (Zs.id = "radialLinear"),
                ...
                (Zs.defaultRoutes = { "angleLines.color": "borderColor", "pointLabels.color": "color", "ticks.color": "color" }),
            ...
            function ea(t, e) {
                ...
                return (
                    ...
                    null === a ? null : (o && (a = "week" !== o || (!Tt(s) && !0 !== s) ? i.startOf(a, o) : i.startOf(a, "isoWeek", s)), +a)
                );
            }
            function ia(t, e, i, n) {
                const o = Js.length;
            ...
            function aa(t, e, i) {
                let n,
                    ...
                    l = t.length - 1;
                i
                    ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r, hi: l } = se(t, "pos", e)), ({ pos: n, time: s } = t[r]), ({ pos: o, time: a } = t[l]))
                    : (e >= t[r].time && e <= t[l].time && ({ lo: r, hi: l } = se(t, "time", e)), ({ time: n, pos: s } = t[r]), ({ time: o, pos: a } = t[l]));
                const c = o - n;
